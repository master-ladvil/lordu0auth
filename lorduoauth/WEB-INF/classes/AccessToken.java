...
public class AccessToken extends HttpServlet {
    ...
    public void addtodb(PublicKey publickey, String accesstoken, String clientid, String userkey) throws Exception {
        // convert publickey to string
        String pubkey = Base64.getUrlEncoder().encodeToString(publickey.getEncoded());
        Statement stmt;
        String query = String.format(
                "insert into accesstoken(accesstoken,clientid,uid,publickey) values('%s','%s','%s','%s');",
                accesstoken, clientid, userkey, pubkey);
    ...
    public String generateAccessToken(String clientid, String scope, String authcode) {
        ...
        try {
            ...
            addtodb(pair.getPublic(), accesstoken, clientid, userkey);
            return accesstoken;
        } catch (Exception e) {
            System.out.println(e);
        }
